...
class Solution:
    ...
    def employeeFreeTime1(self, schedule: List[List[List[int]]]) -> List[List[int]]:
        ...
        for itvs in schedule:
            for itv in itvs:
                lst.append([itv[start], start])
                lst.append([itv[end], end])
    ...
    def employeeFreeTime_error2(self, schedule: List[List[List[int]]]) -> List[List[int]]:
        """
...
if __name__ == "__main__":
    ...
    assert Solution().employeeFreeTime1([[[4,16],[31,36],[42,50],[80,83],[95,96]],[[4,13],[14,19],[37,53],[64,66],[85,89]],[[17,24],[38,39],[49,51],[62,67],[79,81]],[[9,15],[17,24],[45,63],[65,68],[87,88]],[[17,33],[39,41],[43,57],[58,63],[70,84]]]) == [[36, 37], [68, 70], [84, 85], [89, 95]]
